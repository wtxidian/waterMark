head.ready(function() {
	...
	if($("#newActivityPage").length > 0) {
		...
		if($(".mzc_stepTable").length > 0) {
			...
			$.ajax({
                type: 'get',
                url: 'http://127.0.0.1/workspace/super_tag/data/product.json',
				success: function(result) {
					if(result.success == 0) {
						alert("与服务器连接失败。");
                        location.reload();
            ...
            $.ajax({
                type: 'post',
                url: 'http://127.0.0.1/workspace/super_tag/data/wm_list2.json',
            ...
            function updateWMMap(type, page, pagesize) {
                ...
                $.ajax({
                    type: 'get',
                    url: 'http://127.0.0.1/workspace/super_tag/data/wm.json',
